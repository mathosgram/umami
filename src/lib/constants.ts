...
export const AUTH_TOKEN = 'osami.auth';
export const LOCALE_CONFIG = 'osami.locale';
export const TIMEZONE_CONFIG = 'osami.timezone';
export const DATE_RANGE_CONFIG = 'osami.date-range';
export const THEME_CONFIG = 'osami.theme';
export const DASHBOARD_CONFIG = 'osami.dashboard';
export const VERSION_CHECK = 'osami.version-check';
export const SHARE_TOKEN_HEADER = 'x-osami-share-token';
export const HOMEPAGE_URL = 'https://imoogle.com/osami';
export const REPO_URL = 'https://github.com/imoogle/osami';
